...
class Unet(nn.Module):
    def __init__(
        ...
        for ind, (dim_in, dim_out) in enumerate(in_out_ups):
            ...
            up_block = nn.ModuleList([
                ...
                # dim_in * 2 due to skip connection also concatenated
    ...
    def forward(self, x, time, model_kwargs={}):
        ...
        for block in self.ups:
            upsample, resnet1, resnet2 = block
            x = upsample(x)
            
            # Retrieve skip connections and concatenate
            # As pops accumulate it goes through skip connections in reverse order
