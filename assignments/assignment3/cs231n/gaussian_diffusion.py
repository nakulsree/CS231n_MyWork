...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample(self, x_t, t: int, model_kwargs={}):
        ...
        #      and sample x_{t-1}.
        ##################################################################
        # Initial prediction is of noise
        ...
        model_mean, posterior_variance = self.q_posterior(x_start, x_t, t)

        # get random noise value same shape as x_t
        noise = torch.randn_like(x_t)
        x_tm1 = model_mean + posterior_variance * noise
        ##################################################################
